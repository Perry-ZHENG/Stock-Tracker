...
from stock_agent.health.observability import build_observability_summary, format_observability_summary
...
def run_health(
    ...
    *,
    ...
    try:
        ...
        if verbose:
            output.write(format_observability_summary(build_observability_summary(connection)))
        output.flush()
        return HealthCommandResult(
